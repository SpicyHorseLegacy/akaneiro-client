...
public class BuildBundleTexturesWorldMap
{
	
    [MenuItem("Build/Bundle/Textures/WorldMap")]
    public static void Execute()
    {
		List<Texture> TextureList = new List<Texture>();
		
		string[] strGetTexture = Directory.GetFiles( "Assets/TextureBundles/WorldMap","*",SearchOption.AllDirectories);
