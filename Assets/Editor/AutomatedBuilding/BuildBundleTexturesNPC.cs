...
public class BuildBundleTexturesNPC
{
	
    [MenuItem("Build/Bundle/Textures/Npc")]
    public static void Execute()
    {
		List<Texture> TextureList = new List<Texture>();
		
		string[] strGetTexture = Directory.GetFiles( "Assets/TextureBundles/Npc","*",SearchOption.AllDirectories);
