...
public class BuildBundleTexturesMaterial
{
	
    [MenuItem("Build/Bundle/Textures/Materials")]
    public static void Execute()
    {
		List<Texture> TextureList = new List<Texture>();
		
		string[] strGetTexture = Directory.GetFiles( "Assets/TextureBundles/Material","*",SearchOption.AllDirectories);
