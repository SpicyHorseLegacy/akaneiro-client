Shader "Particles/MultiplyRChannel"
{
	Properties 
	{
...
Cull Off
ZWrite Off  // if blend mode is multiply , ZWrite should be Off .
ZTest LEqual
ColorMask RGBA
Blend Zero SrcColor
Fog{
...
float4 Multiply5=Splat2 * Splat3;
float4 Multiply3=Splat1 * Multiply5;
float4 Lerp0=lerp(float4( 1),Multiply2,Multiply3);
