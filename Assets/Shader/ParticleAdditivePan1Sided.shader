Shader "Particles/AdditivePan1Sied"
{
	Properties 
	{
...
float4 UV_Pan1=float4((IN.uv_MainTex.xyxy).x ,(IN.uv_MainTex.xyxy).y + Multiply9.x,(IN.uv_MainTex.xyxy).z,(IN.uv_MainTex.xyxy).w);
