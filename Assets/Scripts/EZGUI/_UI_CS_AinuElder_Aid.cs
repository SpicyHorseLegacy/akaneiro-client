...
public class _UI_CS_AinuElder_Aid : MonoBehaviour {
	...
	public static _UI_CS_AinuElder_Aid Instance;
...
//			    _UI_CS_Resource.Instance.m_AccomplishmentIcon[m_SHItemList[m_CurrentIdx].m_iconID]);
				...
				item.transform.GetComponent<_UI_CS_ItemVendorRawItemCtrl>()
					.item[i].transform.position = new Vector3(item.transform.GetComponent<_UI_CS_ItemVendorRawItemCtrl>().item[i].transform.position.x,
					                                       item.transform.GetComponent<_UI_CS_ItemVendorRawItemCtrl>().item[i].transform.position.y,
					                                        20f);
			}
		}
