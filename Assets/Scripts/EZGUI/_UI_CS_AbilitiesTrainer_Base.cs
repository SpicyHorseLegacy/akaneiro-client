...
public class _UI_CS_AbilitiesTrainer_Base : MonoBehaviour {
	
	public  UIListItemContainer  				m_ItemContainer;
	public  List<_UI_CS_AbilitiesTrainerItem> 	m_AAItemList   = new List<_UI_CS_AbilitiesTrainerItem>();
	public  UIScrollList						m_List;
	protected int 								m_AbilitiesTrainerAllCurrentIdx;
