...
public class _UI_CS_AinuElder_Storage : MonoBehaviour {
	
	public  UIListItemContainer  				m_ItemContainer;
	public  List<_UI_CS_AbilitiesTrainerItem> 		m_ItemList   = new List<_UI_CS_AbilitiesTrainerItem>();
	public  UIScrollList						m_List;
	private int 								m_CurrentIdx;
	private Rect 					 			m_rect;
	public  int 								m_count;
	
	public static _UI_CS_AinuElder_Storage Instance;
	...
	public void AddElement(_UI_CS_AbilitiesTrainerItem element){
...
//				.item[i].transform.GetComponent<_UI_CS_AbilitiesTrainer_AllAItemEx>()
//				.m_AAInfo = m_ItemList[m_CurrentIdx];
//				
//				item.transform.GetComponent<_UI_CS_AbilitiesTrainerRawItemCtrl>()
//				.item[i].transform.GetComponent<_UI_CS_AbilitiesTrainer_AllAItemEx>()
//				.m_ListID = m_CurrentIdx;
//				
//				item.transform.GetComponent<_UI_CS_AbilitiesTrainerRawItemCtrl>().item[i].m_NameText.Text = m_ItemList[m_CurrentIdx].m_name;
//				item.transform.GetComponent<_UI_CS_AbilitiesTrainerRawItemCtrl>().item[i].m_ValText.Text = m_ItemList[m_CurrentIdx].m_val.ToString();
//				item.transform.GetComponent<_UI_CS_AbilitiesTrainerRawItemCtrl>().item[i].m_LevelText.Text = m_ItemList[m_CurrentIdx].m_level.ToString();
