...
public class _UI_CS_ItemVendor_Accessory : MonoBehaviour {
	...
	public static _UI_CS_ItemVendor_Accessory Instance;
	...
	public void Add1hWeaponItemListChild(int childCount){	
		...
		for(int i = 0;i<5;i++){
			if(childCount > i){
				...
				.item[i].transform.GetComponent<_UI_CS_ItemVendorItemEx>().isRareShopItem = false;
				item.transform.GetComponent<_UI_CS_ItemVendorRawItemCtrl>()
				.item[i].transform.GetComponent<_UI_CS_ItemVendorItemEx>()
				.m_ItemVendorInfo = m_ItemList[m_CurrentIdx];
				item.transform.GetComponent<_UI_CS_ItemVendorRawItemCtrl>()
				.item[i].transform.GetComponent<_UI_CS_ItemVendorItemEx>()
