...
public class HUDFPS : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		if (GUI.Button(new Rect(20,100,75,40),"UI")){
			GameObject theUI = GameObject.Find ("UI manager");
			//theUI.gameObject.SendMessage ("toggleUI");
			if (uiStatus == true){
				uiStatus = false ;
...
//		if (GUI.Button(new Rect(20,200,75,40),"Materials")){
//			GameObject theUI = GameObject.Find ("UI manager");
//			theUI.gameObject.SendMessage ("toggleMaterial");
//		}
	}
